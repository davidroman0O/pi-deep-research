...
```mermaid
timeline
    title Evolution of prominent Western SMR cost benchmarks — scopes are not directly comparable
    2019 : GEH BWRX-300 series-production target ≈ US$2,250/kW
    2020 : NuScale 720 MWe CFPP overnight estimate ≈ US$4,167/kW
    2021 : Rolls-Royce mature-unit target £1.8bn ≈ £3,830/kW
    2023 : NuScale CFPP Class 3 total ≈ US$9.24bn / 462 MW ≈ US$20,000/kW project-level
         : CFPP target power price rises to US$89/MWh
         : CFPP cancelled in November
    2024 : DOE update emphasizes design completion, rework avoidance and standardisation as key FOAK-to-NOAK levers
    2025 : Darlington 4-unit budget C$20.9bn / ~1.2 GW ≈ C$17,417/kW all-in
         : TVA planning assumption ≈ US$17,928/kW FOAK and US$12,471/kW NOAK
         : Holtec and TVA receive US$400m each in DOE first-mover support
    2026 : BWRX-300, Rolls-Royce, Xe-100, Natrium and Holtec programmes advance
         : Firm public vendor overnight prices remain scarce
```
...
```mermaid
flowchart LR
    A["Overnight capital cost<br/>$/kW"] --> B["Construction schedule<br/>and expenditure profile"]
    B --> C["Interest during construction<br/>+ financing fees"]
    C --> D["Capitalised cost at COD"]
    D --> E["Annualise with CRF<br/>WACC + asset life"]
    E --> F["Divide by annual output<br/>8,760 × capacity factor"]
    F --> G["Capital component<br/>$/MWh"]
    G --> H["+ fixed O&M<br/>+ variable O&M/fuel<br/>+ taxes/decommissioning<br/>− applicable credits"]
    H --> I["Full project LCOE"]
```
