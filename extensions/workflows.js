...
const drWorkflowExtension = {
  ...
  agentSetupHooks: {
    ...
    // NOTE: optimizer model override now handled by test/runners/optimizer.ts,
    // which launches its own deepseek session via the SDK with optimizerModel
    // from config — no transport interception needed.
  },
};
